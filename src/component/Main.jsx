export default function Main(){
    return(
      ...
      <div className="flex-1 text-left">
        ...
        Hi, my name is Nikita Ahire. I have completed my graduation in Bachelor of Computer Science and master degree in Computer Application. My expertise includes HTML, CSS, Java and JavaScript and react, which allows me to create dynamic and responsive websites.
        </p>
